...
def scopedog_loop(): # run at 1Hz
    global ina, lst, lowBattery, doAlign, az_Joy, alt_rate, az_rate, jStickSpeed, scopeAz, scopeAlt, scopeDec, scopeAz, alt_Joy, go_to, moving, loop, arr,ampHour,scopeRa,scopeDec
    blink = True
    lowBattery = False
    ampHour = 0
    time.sleep(1) 
...
def serveWifi(): # replace with serve WiFi port
    global gotoRa,gotoDec, doAlign, go_to,doMove, dirMove, scopeRa, scopeDec, speed, stopMotion
