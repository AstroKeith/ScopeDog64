...
python -m venv /home/scopedog/venv-efinder --system-site-packages
...
sudo -u scopedog git clone https://github.com/AstroKeith/eFinder64.git
...
venv-efinder/bin/python venv-scopedog/bin/pip install zwoasi
...
echo ""
cp /home/efinder/eFinder64/Solver/*.* /home/scopedog
cp /home/efinder/eFinder64/Solver/de421.bsp /home/scopedog

mkdir /home/scopedog/.config/autostart
cp /home/efinder/eFinder64/efinder.desktop /home/scopedog/.config/autostart
...
echo "after the reboot vnc and ssh should be available at 'scopedogmk3.local'"
