...
def scopedog_loop(): # run at 1Hz
    global az_Joy, alt_rate, az_rate, jStickSpeed, scopeAz, scopeAlt, alt_Joy, go_to, moving, loop
    state = True
...
def performSSgoto():
    ...
    while go_to:
        ...
        #stepsPreDegALT = ((360/stepAngle)*altRatio)/360
        stepsPreDegAZ =  azRatio/stepAngle
        #stepsPreDegAZ =  ((360/stepAngle)*azRatio)/360
        totalStepsAZ = 0
        totalStepsALT = 0
...
def solveImage():
    ...
    #my_solved_altaz = coordinates.conv_altaz(nexus, *(solved_radec))
    ...
    #print('Alt,Az',solved_altaz)
    #print('My Alt,Az',my_solved_altaz)
    solve = True
    deltaCalc()
...
azStepper.openWaitForAttachment(5000)
...
AltStepper.openWaitForAttachment(5000)
